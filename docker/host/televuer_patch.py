...
class TeleVuer:
    ...
    async def on_hand_move(self, event, session, fps=60):
        ...
        Patched: left/right hand data are optional (hand may be out of view).
        Each hand is processed independently so a missing hand doesn't block the other.
        """
        import logging as _logging
        ...
        try:
            ...
            # Update each hand independently — a missing hand doesn't block the other
            if left_hand_data is not None:
